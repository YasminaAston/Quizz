...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function get_Container_Private_SerializerService()
    {
        ...
        return $this->services['.container.private.serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => new \Jose\Bundle\JoseFramework\Normalizer\JWSNormalizer(), 2 => new \Jose\Bundle\JoseFramework\Normalizer\JWENormalizer(), 3 => $g, 4 => $k, 5 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($l, [], $i), 6 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $i), 7 => $k, 8 => $g, 9 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($b, $c, $d, $m, NULL, $l, $f, $i), 10 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($b, $n, $l), 11 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($l, true), 12 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 13 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 14 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 15 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($b, $c, $d, $n, $m, $o, $a, $i, $h, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $p), 16 => new \ApiPlatform\Core\Serializer\ItemNormalizer($c, $d, $n, $m, $a, $i, $h, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $b, $p), 17 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $i), 20 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 24 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($o, $m, $n), 'page', 'pagination', $b, $a), $b, $m, $e), 25 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 26 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($j, $n, $o), 27 => $j], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem'), 6 => new \Jose\Bundle\JoseFramework\Serializer\JWSEncoder(($this->services['Jose\\Component\\Signature\\Serializer\\JWSSerializerManagerFactory'] ?? $this->getJWSSerializerManagerFactoryService())), 7 => new \Jose\Bundle\JoseFramework\Serializer\JWEEncoder(($this->services['Jose\\Component\\Encryption\\Serializer\\JWESerializerManagerFactory'] ?? $this->getJWESerializerManagerFactoryService()))]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('uqstpwJYSW', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MQMgxckP94', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('l04+AYCxwd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('T7cq-79Bwp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('pE8HI13Zyt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ybwew7QLMg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1NjFCwZRKJ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
