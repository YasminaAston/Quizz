 ...
 */
class Score extends \App\Entity\Score implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Score' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Score' . "\0" . 'score'];
        }
     ...
     * {@inheritDoc}
     */
    public function setScore(int $score): \App\Entity\Score
    {
