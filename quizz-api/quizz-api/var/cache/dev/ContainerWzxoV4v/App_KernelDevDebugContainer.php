...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-signature/Serializer/JWSSerializerManagerFactory.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-signature/Serializer/JWSSerializer.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-signature/Serializer/Serializer.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-signature/Serializer/CompactSerializer.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-signature/Serializer/JSONFlattenedSerializer.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-signature/Serializer/JSONGeneralSerializer.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-encryption/Serializer/JWESerializerManagerFactory.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-encryption/Serializer/JWESerializer.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-encryption/Serializer/CompactSerializer.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-encryption/Serializer/JSONFlattenedSerializer.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-encryption/Serializer/JSONGeneralSerializer.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-bundle/Normalizer/JWSNormalizer.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-bundle/Normalizer/JWENormalizer.php';
            ...
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-bundle/Serializer/JWSEncoder.php';
            include_once \dirname(__DIR__, 4).'/vendor/web-token/jwt-bundle/Serializer/JWEEncoder.php';
    ...
    protected function get_Container_Private_SerializerService()
    {
        ...
        return $this->services['.container.private.serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => new \Jose\Bundle\JoseFramework\Normalizer\JWSNormalizer(), 2 => new \Jose\Bundle\JoseFramework\Normalizer\JWENormalizer(), 3 => new \FOS\RestBundle\Serializer\Normalizer\FormErrorNormalizer(), 4 => $e, 5 => $k, 6 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($l, [], $m), 7 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $m), 8 => $k, 9 => $e, 10 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($f, $g, $h, $n, NULL, $l, $j, $m), 11 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($f, $o, $l), 12 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($l, true), 13 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 14 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 15 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 16 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($f, $g, $h, $o, $n, $p, $a, $m, $q, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $r), 17 => new \ApiPlatform\Core\Serializer\ItemNormalizer($g, $h, $o, $n, $a, $m, $q, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $f, $r), 18 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $m), 21 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 24 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 25 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($p, $n, $o), 'page', 'pagination', $f, $a), $f, $n, $i), 26 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 27 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($s, $o, $p), 28 => $s], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $c, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem'), 6 => new \Jose\Bundle\JoseFramework\Serializer\JWSEncoder(($this->services['Jose\\Component\\Signature\\Serializer\\JWSSerializerManagerFactory'] ?? $this->getJWSSerializerManagerFactoryService())), 7 => new \Jose\Bundle\JoseFramework\Serializer\JWEEncoder(($this->services['Jose\\Component\\Encryption\\Serializer\\JWESerializerManagerFactory'] ?? $this->getJWESerializerManagerFactoryService()))]);
    }
     ...
     */
    protected function getJWESerializerManagerFactoryService()
    {
        $this->services['Jose\\Component\\Encryption\\Serializer\\JWESerializerManagerFactory'] = $instance = new \Jose\Component\Encryption\Serializer\JWESerializerManagerFactory();
     ...
     */
    protected function getJWSSerializerManagerFactoryService()
    {
        $this->services['Jose\\Component\\Signature\\Serializer\\JWSSerializerManagerFactory'] = $instance = new \Jose\Component\Signature\Serializer\JWSSerializerManagerFactory();
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['url' => $this->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => []], $a, $b, ['enum' => 'string', 'bit' => 'boolean']);
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\HeaderCheckedSuccessEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector'] ?? $this->load('getCheckerCollectorService'));
        }, 1 => 'catchHeaderCheckSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\HeaderCheckedFailureEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector'] ?? $this->load('getCheckerCollectorService'));
        }, 1 => 'catchHeaderCheckFailure'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\ClaimCheckedSuccessEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector'] ?? $this->load('getCheckerCollectorService'));
        }, 1 => 'catchClaimCheckSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\ClaimCheckedFailureEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector'] ?? $this->load('getCheckerCollectorService'));
        }, 1 => 'catchClaimCheckFailure'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWEDecryptionSuccessEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector'] ?? $this->load('getJWECollectorService'));
        }, 1 => 'catchJweDecryptionSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWEDecryptionFailureEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector'] ?? $this->load('getJWECollectorService'));
        }, 1 => 'catchJweDecryptionFailure'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWEBuiltSuccessEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector'] ?? $this->load('getJWECollectorService'));
        }, 1 => 'catchJweBuiltSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWEBuiltFailureEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector'] ?? $this->load('getJWECollectorService'));
        }, 1 => 'catchJweBuiltFailure'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWSVerificationSuccessEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector'] ?? $this->load('getJWSCollectorService'));
        }, 1 => 'catchJwsVerificationSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWSVerificationFailureEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector'] ?? $this->load('getJWSCollectorService'));
        }, 1 => 'catchJwsVerificationFailure'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWSBuiltSuccessEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector'] ?? $this->load('getJWSCollectorService'));
        }, 1 => 'catchJwsBuiltSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWSBuiltFailureEvent', [0 => function () {
            return ($this->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector'] ?? $this->load('getJWSCollectorService'));
        }, 1 => 'catchJwsBuiltFailure'], 0);
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('F6TM9ymULy', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4meGT5116v', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fwM+3pp1nO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vgi8-iQ8iY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HB-dYAjgSj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('LYXCuaUdMi', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EwLE-7oZ1O', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'JoseFrameworkBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/vendor/web-token/jwt-bundle'),
            ...
            'api_platform.description' => 'A Symfony API to manage a simple blog app.',
